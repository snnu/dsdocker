...
public class RegistryTemplate {
    ...
    public Boolean locationManagerAllowRegistry(String address, String paltformIP) {
        MultiValueMap<String, String> params = new LinkedMultiValueMap<String, String>();
        params.add("address", address);
        String url = String.format("http://%s:8080/v1/platform/address/allowRegistryAddress", paltformIP);
