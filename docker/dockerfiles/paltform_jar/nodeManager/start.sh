...
CLASSPATH='/app/webase/nodeManager/conf/:/app/webase/nodeManager/apps/*:/app/webase/nodeManager/lib/*'
CURRENT_DIR=/app/webase/nodeManager/
...
copyArial(){
    ...
    if [ ! -d "$arialFolder" ]; then
        mkdir -p "$arialFolder" && cp $ARIAL_DIR/arial*.ttf $arialFolder/
    fi
}
